...
export const projects: Project[] = [
  {
    ...
    slug: "jargon",
    title: "Jargon",
    description: "Building a seamless path to better cellular health through intuitive app design",
    fullDescription: "Meridian Health approached us to redesign their flagship mobile application, focusing on creating a more intuitive user experience that would help users track and improve their cellular health metrics.",
    tags: ["Mobile App", "Trades", "UI/UX"],
    image: "/projects/project-1.jpg",
    category: "ui-ux",
    year: "2025",
    client: "ConnectHER Hub",
    role: "Co-Lead UI/UX Designer",
    duration: "4 months",
    tools: ["Figma", "AI Illustrator", "Frontend"],
    overview: "This project involved a complete redesign of Meridian Health's mobile application, transforming it from a data-heavy medical tool into an intuitive wellness companion. Working closely with their medical team and user research specialists, we developed a design language that makes complex health metrics accessible to everyday users while maintaining the precision required for medical applications.",
    challenge: "The existing app had a 2.3 star rating with users citing confusion around data interpretation and a cluttered interface. The challenge was to simplify complex health data while maintaining scientific accuracy.",
    solution: "We implemented a card-based dashboard system with progressive disclosure, allowing users to see high-level metrics at a glance while drilling down into detailed data when needed. Custom data visualizations were designed to make health trends immediately understandable.",
    results: "The redesigned app launched to overwhelmingly positive reception, achieving a 4.8 star rating within the first month. User engagement increased by 340%, with daily active users spending an average of 12 minutes in the app compared to the previous 3 minutes. Most importantly, users reported feeling more confident in understanding and acting on their health data, with 78% stating the app helped them make positive lifestyle changes.",
