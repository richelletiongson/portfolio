...
export const projects: Project[] = [
  ...
  },
  {
    ...
    slug: "linko",
    title: "Linko",
    description: "Bringing people together through the power and shared passion for music.",
    fullDescription: "Linko is a music-focused social app that connects people through live music, discovery, and events—creating connections, building communities, and turning every concert into a chance for lasting memories.",
    tags: ["Mobile App", "Music", "UI/UX", "Frontend"],
    ...
    duration: "5 months",
    tools: ["Figma", "Javascript"],
    overview: "Linko is a concept-driven app focused on connecting people through live music, discovery, and events. It allows users to discover concerts, match with others who share their music taste, and build communities around shared passion—turning every concert into an opportunity to create lasting connections and unforgettable moments.",
    challenge: "People often lack meaningful, interest-based social connections, especially when in new cities. Music can bridge this gap, but there was no dedicated platform that combined concert discovery with social matching and community building in one place.",
    solution: "We designed a music-centered social platform with interest-based matching, concert discovery, and user profiles. The app simplifies finding events and connecting with like-minded people through a familiar, emotionally comfortable interface that prioritizes simplicity and clarity.",
    results: "Linko fosters connection and belonging by turning music and live events into social touchpoints. Users report forming real friendships and feeling less isolated, with the app helping them discover both events and people who share their passion for music.",
    gallery: ["/projects/project-2.jpg", "/projects/project-3.jpg", "/projects/project-4.jpg"],
    layout: "case-study",
    tagline: "Linko, bringing people together through the power and shared passion for music, creating connections, building communities, and turning every concert into a chance to create lasting memories and unforgettable moments.",
    rolesDisplay: "UI/UX Designer, Frontend Developer",
    introImage: "/projects/project-2.jpg",
    wireframeLowFi: "/projects/project-3.jpg",
    wireframeHighFi: "/projects/project-2.jpg",
    userFlowImage: "/projects/project-3.jpg",
    styleGuideDescription: "Linko's design principles center on simplicity, familiarity, and emotional comfort. The visual system uses a bold purple primary (#6748EE), lime green (#A3FF48), and pink/red accent (#FF4848) on dark backgrounds (#1D0D3F), with gradients and the Ruffly & Lexend type families to create a distinctive, music-forward identity.",
    styleGuideImage: "/projects/project-4.jpg",
  },
  {
    id: 3,
    slug: "aesthea",
